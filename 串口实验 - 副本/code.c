...
//	}
	...
	//	GPIO_ResetBits(GPIOE,GPIO_Pin_4);//蜂鸣器低电平报警
	//}
...
{ /*引脚设置*/
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5|GPIO_Pin_0|GPIO_Pin_6|GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_8|GPIO_Pin_3|GPIO_Pin_4|GPIO_Pin_7;
