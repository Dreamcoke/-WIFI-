...
#define DATA_2_LOW()      GPIO_ResetBits(GPIOB,GPIO_Pin_4)//复位总线第2位
#define DATA_2_HIGH()     GPIO_SetBits(GPIOB,GPIO_Pin_4)//置数据总线第2位

#define DATA_3_LOW()      GPIO_ResetBits(GPIOB,GPIO_Pin_11)//复位总线第3位
#define DATA_3_HIGH()     GPIO_SetBits(GPIOB,GPIO_Pin_11)//置数据总线第3位
...
void Port_Init_1602(void)
{
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	GPIO_InitStructure.GPIO_Pin=GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_13|GPIO_Pin_14|GPIO_Pin_15|GPIO_Pin_4;
	GPIO_InitStructure.GPIO_Mode=GPIO_Mode_Out_PP;
		GPIO_InitStructure.GPIO_Speed=GPIO_Speed_50MHz;
	GPIO_Init(GPIOB,&GPIO_InitStructure);
